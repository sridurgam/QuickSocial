...
if __name__ == "__main__":
    ...
    #isSuperNode(supernodes_rdd_raw,r.split()[0])
    #similarityMeasure(vertex_df,r.split[0],r.split[1])
    #similarityMeasure(vertex_df,r.split()[0],r.split()[1])
	...
	#testSaveToS3(local_vertices_filepath, s3_vertices_filepath) '''